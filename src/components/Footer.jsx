export default function Footer() {
  return (
    <footer
      className="bg-gradient-to-r from-blue-500 via-blue-400 to-pink-400 text-white py-8 px-4 lg:px-8 text-center flex flex-col gap-6 lg:flex-row md:justify-between md:gap-8"
      id="footer"
    >
